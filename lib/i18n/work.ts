...
const en = {
	...
	privateList: {
		...
		emptyFiltered: "No items match this search",
		open: "Open",
		finished: "Finished",
		glance: (n: number) => (n === 1 ? "1 open" : `${n} open`),
		search: "Search your list",
		itemTitle: "Item",
		back: "Back to My list",
		markDone: "Mark done",
		markOpen: "Mark open",
		markItemDone: (title: string) => `Mark "${title}" done`,
		columns: {
			linked: "Linked task",
		},
...
const de: WorkDictionary = {
	...
	privateList: {
		...
		emptyFiltered: "Keine Einträge passen zur Suche",
		open: "Offen",
		finished: "Erledigt",
		glance: (n) => (n === 1 ? "1 offen" : `${n} offen`),
		search: "Liste durchsuchen",
		itemTitle: "Eintrag",
		back: "Zurück zu meiner Liste",
		markDone: "Als erledigt markieren",
		markOpen: "Als offen markieren",
		markItemDone: (title) => `„${title}" als erledigt markieren`,
		columns: {
			linked: "Verknüpfte Aufgabe",
		},
