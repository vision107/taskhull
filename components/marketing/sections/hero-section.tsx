			...
			<div className="mx-auto flex max-w-2xl flex-col gap-16 px-6 md:max-w-3xl lg:max-w-7xl lg:px-10">
				<div className="flex flex-col gap-32">
					<div className="flex flex-col items-start gap-6">
						...
						>
							A hull for the week ahead.
						</h1>

						{/* Description */}
						<div className="flex max-w-3xl flex-col gap-4 text-lg leading-8 text-marketing-fg-muted">
							<p>
								Taskhull keeps your tasks, projects and deadlines afloat. A
								calm, opinionated workspace for people who ship — without the
								dashboards, the noise, or the five-seat minimum.
							</p>
						</div>
